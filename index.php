		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h2 class="mb-2"><strong>𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘 𝐂𝐇𝐄𝐂𝐊𝐄𝐑💸</strong></h2>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/frank_xox">JOIN OUR COMMUNITY CLICK HERE </a>
					<textarea rows="12" class="form-control text-center form-checker mb-2" placeholder="PAST YOUR FUCKING CC'S HERE( ͡° ͜ʖ ͡°)" style="color:#00ff5594"></textarea>
					...
					<select style="background-color: #1D1D1D;; name="gate" id="gate" class="form-control" style="margin-bottom: 5px;"
					<option </option>
								<option style="background-color: #1D1D1D;" value="gate/AUTH.php">No Cherge</option>
								<option style="background-color: #1D1D1D;" value="gate/usd1.php">Charge $1</option>
								<option style="background-color: #1D1D1D;" value="gate/eur1.php">Charge €1</option>
								<option style="background-color: #1D1D1D;" value="gate/sk.php">Sk Base</option>
								<option style="background-color: #1D1D1D;" value="nonsk/chk.php">Non Sk</option>
								<option style="background-color: #1D1D1D;" value="api/api.php">Api Base</option>
				</select>
	<br>										
...
<h5>DEAD :<span class="badge badge-danger float-right reprovadas">0</span></h5><hr>
  ...
  box-shadow: 0 0 5px #ff0700;
	 ...
	 <div class="app-content content" style="display:block;">
	  ...
	  <center>
        <p class="hunter_credit">CHECKER BY <a href="https://t.me/frank_xx" class="link">F R A N K</a></p>
    </center>

	  <footer>
  <p><a href="https://t.me/frank_xx"></a></p>
</footer>
<script>
...
function RedirectUrl(){    
       window.location.href ="https://t.me/frank_xx";
    }
...
if(total > 50000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <49999', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
