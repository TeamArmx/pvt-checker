...
if(strpos($result3, '"seller_message": "Payment complete."' )) {
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: Charged ✅  <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
...
elseif(strpos($result3, "lost_card" )) {
    echo '#DIE</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD </span></span>  <br>Result: CHECKER BY </span> <br>';
}
