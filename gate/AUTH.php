...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'description=Tx-Code Auth&source='.$token.'');
curl_setopt($ch, CURLOPT_USERPWD, $sk . ':' . '');
$headers = array();
...
elseif(strpos($result3, "lost_card" )) {
    echo 'DEAD</span>  </span>CC:  '.$lista.'</span>  <br>Result: LOST CARD</span></span>  <br>Result: CHECKER BY Tx-Code</span> <br>';
}
...
elseif(strpos($result1, "card_not_supported" )) {
    ...
    echo 'DEAD</span> CC:  '.$lista.'</span>  <br>Result: '.$result2.'</span><br>';
}
